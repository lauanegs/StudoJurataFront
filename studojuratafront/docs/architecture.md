...
10. **i18n inexistente.** Todos os textos de UI estão escritos direto nas telas, em português. Adotar i18n é uma decisão própria (biblioteca, organização dos arquivos de tradução), ainda não tomada.
